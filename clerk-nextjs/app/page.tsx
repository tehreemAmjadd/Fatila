    ...
    <div className="relative text-white min-h-screen w-full overflow-hidden">
      ...
      <style>{`
        ...
        .top-banner::before {
          ...
          background: linear-gradient(90deg,
            transparent 0%,
            rgba(57,211,83,0.08) 30%,
            rgba(47,164,255,0.08) 60%,
            transparent 100%
          );
          pointer-events: none;
        }
        ...
        .banner-arrow-icon {
          animation: arrowPing 1.2s ease-in-out infinite;
      ...
      <div className="relative z-10">
        ...
        <div className="top-banner w-full py-2 px-4 flex items-center justify-center gap-3 fixed top-0 left-0 right-0 z-[70]">
              ...
              {[0,1].map(i => (
                <span key={i} className="flex items-center gap-6 pr-6">
                  <span className="text-white text-xs font-semibold tracking-wide whitespace-nowrap">
                    🚀 Start Finding Your Leads for <span className="text-[#39d353] font-bold">Free</span> — No Credit Card Required
                  </span>
                  <span className="text-[#39d353] text-xs">✦</span>
                  <span className="text-[#c8d6ff] text-xs whitespace-nowrap">
                    10,000+ Leads Already Generated
                  </span>
                  <span className="text-[#2fa4ff] text-xs">✦</span>
                  <span className="text-white text-xs font-semibold whitespace-nowrap">
                    🌍 35+ Countries &nbsp;·&nbsp; 120+ Industries
                  </span>
                  <span className="text-[#39d353] text-xs">✦</span>
                  <span className="text-[#c8d6ff] text-xs whitespace-nowrap">
          ...
          <button
            ...
            className="banner-arrow hidden sm:inline-flex"
          >
            Try Free
        ...
        {/* ── NAVBAR ── */}
        <nav className="fixed top-[38px] left-0 left-0 right-0 mx-auto flex justify-between items-center px-10 py-4 w-[90%] max-w-[1100px] rounded-[60px] bg-[rgba(7,31,74,0.55)] backdrop-blur-[16px] border border-[rgba(0,170,255,.25)] z-50">
        ...
        {/* ── HERO ── */}
        <section className="text-center max-w-[900px] mx-auto relative pt-[295px] pb-[120px] px-5">
